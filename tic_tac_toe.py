...
crossImg = [pygame.image.load('image/cross/1.png'),pygame.image.load('image/cross/2.png'),pygame.image.load('image/cross/3.png'),pygame.image.load('image/cross/4.png'),pygame.image.load('image/cross/5.png'),pygame.image.load('image/cross/6.png'),pygame.image.load('image/cross/7.png'),pygame.image.load('image/cross/8.png'),pygame.image.load('image/cross/9.png'),pygame.image.load('image/cross/10.png')]
def put_cross(x,y):
    for i in range(0,600):
        screen.blit(crossImg[i//60], (x,y))
        pygame.display.update()

oImg = [pygame.image.load('image/o/1.png'),pygame.image.load('image/o/2.png'),pygame.image.load('image/o/3.png'),pygame.image.load('image/o/4.png'),pygame.image.load('image/o/5.png'),pygame.image.load('image/o/6.png'),pygame.image.load('image/o/7.png'),pygame.image.load('image/o/8.png'),pygame.image.load('image/o/9.png'),pygame.image.load('image/o/10.png'),]
def put_o(x,y):
    for i in range(0,600):
        screen.blit(oImg[i//60], (x,y))
        pygame.display.update()

vImg = [pygame.image.load('image/ver/1.png'),pygame.image.load('image/ver/2.png'),pygame.image.load('image/ver/3.png'),pygame.image.load('image/ver/4.png'),pygame.image.load('image/ver/5.png'),pygame.image.load('image/ver/6.png'),pygame.image.load('image/ver/7.png'),pygame.image.load('image/ver/8.png'),pygame.image.load('image/ver/9.png'),pygame.image.load('image/ver/10.png'),]
def put_v(x):
    for i in range(0,400):
        screen.blit(vImg[i//40], (0,x))
        pygame.display.update()

hImg = [pygame.image.load('image/hor/1.png'),pygame.image.load('image/hor/2.png'),pygame.image.load('image/hor/3.png'),pygame.image.load('image/hor/4.png'),pygame.image.load('image/hor/5.png'),pygame.image.load('image/hor/6.png'),pygame.image.load('image/hor/7.png'),pygame.image.load('image/hor/8.png'),pygame.image.load('image/hor/9.png'),pygame.image.load('image/hor/10.png'),]
def put_h(y):
    for i in range(0,400):
        screen.blit(hImg[i//40], (y,0))
        pygame.display.update()

rImg = [pygame.image.load('image/r_digo/1.png'),pygame.image.load('image/r_digo/2.png'),pygame.image.load('image/r_digo/3.png'),pygame.image.load('image/r_digo/4.png'),pygame.image.load('image/r_digo/5.png'),pygame.image.load('image/r_digo/6.png'),pygame.image.load('image/r_digo/7.png'),pygame.image.load('image/r_digo/8.png'),pygame.image.load('image/r_digo/9.png'),pygame.image.load('image/r_digo/10.png'),]
def put_rd():
    for i in range(0,400):
        screen.blit(rImg[i//40], (0,0))
        pygame.display.update()

lImg = [pygame.image.load('image/l_digo/1.png'),pygame.image.load('image/l_digo/2.png'),pygame.image.load('image/l_digo/3.png'),pygame.image.load('image/l_digo/4.png'),pygame.image.load('image/l_digo/5.png'),pygame.image.load('image/l_digo/6.png'),pygame.image.load('image/l_digo/7.png'),pygame.image.load('image/l_digo/8.png'),pygame.image.load('image/l_digo/9.png'),pygame.image.load('image/l_digo/10.png'),]
def put_ld():
    for i in range(0,400):
